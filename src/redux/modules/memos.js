...
const LOAD = 'omzug/memos/LOAD';
const LOAD_SUCCESS = 'omzug/memos/LOAD_SUCCESS';
const LOAD_FAIL = 'omzug/memos/LOAD_FAIL';
const SUBMIT = 'omzug/memos/SUBMIT';
const SUBMIT_SUCCESS = 'omzug/memos/SUBMIT_SUCCESS';
const SUBMIT_FAIL = 'omzug/memos/SUBMIT_FAIL';
const CLEAR = 'omzug/memos/CLEAR'
const OPEN_CONTACT = "omzug/memos/OPEN_CONTACT";
const CLOSE_CONTACT = "omzug/memos/CLOSE_CONTACT";
const START_EDIT = "omzug/memos/START_EDIT";
const END_EDIT = "omzug/memos/END_EDIT";
const CACHE_DATA = "omzug/memos/CACHE_DATA";
const ADD_IMAGE = "omzug/memos/ADD_IMAGE";
const DELETE_IMAGE = "omzug/memos/DELETE_IMAGE";
const CHANGE_SLIDE = "omzug/memos/CHANGE_SLIDE";
const SUBMIT_NEW_SUCCESS = "omzug/memos/SUBMIT_NEW_SUCCESS";
const CLEAR_MESSAGE = "omzug/memos/CLEAR_MESSAGE";
const LOG_ERROR = "omzug/memos/LOG_ERROR";
const INIT_ENTITY = "omzug/memos/INIT_ENTITY";
const TOGGLE = "omzug/memos/TOGGLE";
const CHANGE_TYPE = "omzug/memos/CHANGE_TYPE";
const CHANGE_PRICE_TYPE = "omzug/memos/CHANGE_PRICE_TYPE";
const CALCULATE_GEOMETRY = "omzug/memos/CALCULATE_GEOMETRY";
const CHANGE_SEARCH_VALUE = "omzug/memos/CHANGE_SEARCH_VALUE";
const SUBMIT_NEW_FAIL = "omzug/memos/SUBMIT_NEW_FAIL";
const CLEAR_LOAD_ERROR = "omzug/memos/CLEAR_LOAD_ERROR"
...
export function onLoad(number){
  console.log("request number is" , number) //TODO
  return {
    types: [LOAD, LOAD_SUCCESS, LOAD_FAIL],
    promise: (client) => {
      const url = '/entity/' + number
